...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Real-time punch-in/out and monthly logs",
  },
  {
    icon: CreditCard,
    label: "Payroll Processing",
    desc: "Automated salary generation & payslips",
  },
  {
    icon: BarChart3,
    label: "Analytics & Reports",
    desc: "In-depth HR insights and data exports",
  },
];
    ...
    >
      ...
      <div
        style={{
          width: "46%",
          background:
            "linear-gradient(145deg, #384959 0%, #2e3c4a 50%, #1f2c38 100%)",
          display: "flex",
      ...
      >
        ...
        <div
          style={{
            ...
            height: "240px",
            borderRadius: "50%",
            background: "rgba(136, 205, 242, 0.08)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <p
            style={{
              color: "rgba(168, 191, 207, 0.75)",
              fontSize: "0.9375rem",
              lineHeight: 1.6,
              maxWidth: "300px",
            }}
          >
            A comprehensive HR & payroll platform trusted by teams to streamline
          ...
          >
            <div
              style={{
                ...
                height: "44px",
                borderRadius: "10px",
                background: "rgba(136, 205, 242, 0.15)",
                display: "flex",
                alignItems: "center",
            ...
            {FEATURES.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "99px",
                  background:
                    i === featureIdx ? "#88CDF2" : "rgba(168,191,207,0.3)",
      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: "36px" }}>
            ...
            >
              Sign in to your WorkBalance Suite account to continue.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <span>
                  Username:{" "}
                  <strong style={{ color: "var(--text-main)" }}>admin</strong>
                </span>
                <span>
                  Password:{" "}
          ...
          >
            © {new Date().getFullYear()} WorkBalance Suite . All rights
            reserved.
          </p>
        </div>
      </div>
